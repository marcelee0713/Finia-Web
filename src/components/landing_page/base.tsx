...
export const Base = () => {
  return (
    <div className="flex-1 flex flex-col items-center justify-center text-secondary text-center text-base gap-8">
      ...
      <Link className="font-bold animate-animfadeBelow" href={"/sign-in"}>
        Sign in
      </Link>
    </div>
  );
