...
export const ForgotPasswordForm = () => {
  ...
  return (
    <form
      ...
      className="flex flex-col gap-5 h-[300px] tall:min-h-[400px] max-h-full w-[400px] border border-borderColor rounded-lg bg-primary p-5 py-6 lg:p-8 overflow-y-auto no-scrollbar animate-animfadeAbove"
    >
